...
export default function Footer() {
  return (
    <footer className="flex w-full px-25 py-3 justify-between items-center border-t-2 border-white bg-black">
      <div className="flex flex-row w-full max-w-[1440px] mx-auto justify-between">
